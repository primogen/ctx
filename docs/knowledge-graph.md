...
is **13,252 nodes** (1,984 curated skills + 467 agents + 10,787 MCP servers
...
|---|---:|
| Total nodes | **102,715** |
| Curated core nodes | **13,252** (1,984 skills + 467 agents + 10,787 MCP servers + 14 harnesses) |
| Remote-cataloged Skills.sh skill nodes | **89,463** (`skill`, `status=remote-cataloged`, body-backed) |
| Total edges | **2,911,126** |
